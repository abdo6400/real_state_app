...
class ProfileDataSourceImpl extends ProfileDataSource {
  ...
  Future<UserModel> getUser() async {
    final response = await _apiConsumer.get(EndPoints.owner);
  ...
  Future<UserModel> editUser(String phone, String name) async {
    final response = await _apiConsumer
        .patch(EndPoints.owner, body: {"phone": phone, "name": name});
  ...
  Future<String> deleteUser() async {
    final response = await _apiConsumer.delete(EndPoints.owner);
